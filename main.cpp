...
struct CtpConfig {
    // 公共参数
    std::string broker_id;       // 模拟经纪商代码
    std::string invester_id;     // 投资者账户名
    std::string invester_passwd; // 投资者密码

    // 行情参数
    std::string md_front_addr; // 模拟行情前置地址
    // 交易参数
    std::string trade_front_addr; // 模拟交易前置地址
};
